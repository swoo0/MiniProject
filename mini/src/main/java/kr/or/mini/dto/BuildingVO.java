...
public class BuildingVO {
	...
	public String total;      // 전체공시가격
	public String pyeong;     // 단위면적가격
	public String roomCnt;    // 산정공동주택호수
	public String average1;   // 과년도1평균공시가격
	public String average2;   // 과년도2평균공시가격
	public String average3;   // 과년도3평균공시가격
	...
	public String getxCoordi() {
		return xCoordi;
	}
	public void setxCoordi(String xCoordi) {
		this.xCoordi = xCoordi;
	}
	public String getyCoordi() {
		return yCoordi;
	}
	public void setyCoordi(String yCoordi) {
